...
class Configuartion:
    ...
    def get_data_ingestion_config(self) ->DataIngestionConfig:
        try:
            ##First we need root directory/artifact directory
            artifact_dir = self.training_pipeline_config.artifact_dir
            ## And then we create data_ingestion folder
            data_ingestion_artifact_dir=os.path.join(
                artifact_dir,
                DATA_INGESTION_ARTIFACT_DIR,
                self.time_stamp
            )
            ##self.config_info contains the information of yaml file as a dictionary
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            artifact_dir = self.training_pipeline_config.artifact_dir ##We need top level artifact directory basically pipeline level artifact
